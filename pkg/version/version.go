...
var (
	// Version is the current semver release (e.g. "0.0.1") or "dev".
	// Overridden at build time via -ldflags "-X github.com/divmora/code-reviewer-ai-agent/pkg/version.Version=...".
	Version = "dev"

	// GitCommit is the git commit SHA of the build.
	// Overridden at build time via -ldflags "-X github.com/divmora/code-reviewer-ai-agent/pkg/version.GitCommit=...".
	GitCommit = "none"

	// BuildDate is the RFC3339 formatted build timestamp.
	// Overridden at build time via -ldflags "-X github.com/divmora/code-reviewer-ai-agent/pkg/version.BuildDate=...".
	BuildDate = "unknown"
...
func (i Info) String() string {
	return fmt.Sprintf("code-reviewer %s (commit: %s, date: %s, go: %s, platform: %s)",
